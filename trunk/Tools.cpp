		...
		if(strcmp(languageName, (const char*)(*it).language) == 0)
		{
			for(int i = 0; i <= LANGUAGE_STRINGS; i++)
			{
				...
				if(strcmp(languageName, "Polish") == 0)
				{
					...
					replaceString(str, "#262;", "Æ");
					replaceString(str, "#263;", "æ");

					replaceString(str, "#280;", "Ê");
					replaceString(str, "#281;", "ê");

					replaceString(str, "#321;", "£");
					replaceString(str, "#322;", "³");

					replaceString(str, "#323;", "Ñ");
					replaceString(str, "#324;", "ñ");

					replaceString(str, "#211;", "Ó");
					replaceString(str, "#243;", "ó");

					replaceString(str, "#346;", "Œ");
					replaceString(str, "#347;", "œ");

					replaceString(str, "#377;", "");
					replaceString(str, "#378;", "Ÿ");
